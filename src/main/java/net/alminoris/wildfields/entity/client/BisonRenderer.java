...
public class BisonRenderer extends GeoEntityRenderer<BisonEntity>
{
    ...
    @Override
    public void preRender(MatrixStack poseStack, BisonEntity entity, BakedGeoModel model, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour)
    {
        if (entity.isBaby())
