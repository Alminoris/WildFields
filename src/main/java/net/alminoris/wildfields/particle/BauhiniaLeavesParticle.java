...
public class BauhiniaLeavesParticle extends SpriteBillboardParticle
{
    ...
    public BauhiniaLeavesParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider)
    {
        super(world, x, y, z);
